        ...
        <a href="project_description.php" id="showcase">
            <div class="relative h-[400px]">
                <div id="default-carousel" class="relative w-full z-[1]" data-carousel="slide">
                    ...
                    <div class="absolute z-[20] bg-black/25 h-full w-full top-0 hover:bg-black/75 hover:opacity-75">
                        <h1 class="absolute w-full text-gray-50 drop-shadow-md bottom-4 px-[0.7rem] font-bold text-left.... max-[320px]:text-[1.8rem] .... min-[320px]:text-[1.8rem] .... min-[768px]:text-[2.5rem]">Bungalow.1</h1>
                    </div>
        ...
        <a href="project_description.php" id="showcase">
            <div class="relative h-[400px]">
                <div id="default-carousel" class="relative w-full z-[1]" data-carousel="slide">
                    ...
                    <div class="absolute z-[20] bg-black/25 h-full w-full top-0 hover:bg-black/75 hover:opacity-75">
                        <h1 class="absolute w-full text-gray-50 drop-shadow-md bottom-4 px-[0.7rem] font-bold text-left.... max-[320px]:text-[1.8rem] .... min-[320px]:text-[1.8rem] .... min-[768px]:text-[2.5rem]">School.1</h1>
                    </div>
        ...
        <a href="project_description.php" id="showcase">
            <div class="relative h-[400px]">
                <div id="default-carousel" class="relative w-full z-[1]" data-carousel="slide">
                    ...
                    <div class="absolute z-[20] bg-black/25 h-full w-full top-0 hover:bg-black/75 hover:opacity-75">
                        <h1 class="absolute w-full text-gray-50 drop-shadow-md bottom-4 px-[0.7rem] font-bold text-left.... max-[320px]:text-[1.8rem] .... min-[320px]:text-[1.8rem] .... min-[768px]:text-[2.5rem]">School.2</h1>
                    </div>
                    <h2 class="hidden" id="category-value">School</h2>
                </div>
            </div>
        ...
        <a href="project_description.php" id="showcase">
            <div class="relative h-[400px]">
                <div id="default-carousel" class="relative w-full z-[1]" data-carousel="slide">
                    ...
                    <div class="absolute z-[20] bg-black/25 h-full w-full top-0 hover:bg-black/75 hover:opacity-75">
                        <h1 class="absolute w-full text-gray-50 drop-shadow-md bottom-4 px-[0.7rem] font-bold text-left.... max-[320px]:text-[1.8rem] .... min-[320px]:text-[1.8rem] .... min-[768px]:text-[2.5rem]">School.3</h1>
                    </div>
                    <h2 class="hidden" id="category-value">School</h2>
                </div>
            </div>
        ...
        <a href="project_description.php" id="showcase">
            <div class="relative h-[400px]">
                <div id="default-carousel" class="relative w-full z-[1]" data-carousel="slide">
                    ...
                    <div class="absolute z-[20] bg-black/25 h-full w-full top-0 hover:bg-black/75 hover:opacity-75">
                        <h1 class="absolute w-full text-gray-50 drop-shadow-md bottom-4 px-[0.7rem] font-bold text-left.... max-[320px]:text-[1.8rem] .... min-[320px]:text-[1.8rem] .... min-[768px]:text-[2.5rem]">School.4</h1>
                    </div>
                    <h2 class="hidden" id="category-value">School</h2>
                </div>
            </div>
